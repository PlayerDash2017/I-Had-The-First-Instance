...
function scrSetGlobalOptions() {
	...
	global.menuSound = sndSelect;         //Sets what sound to use for navigating the main menu

	//World
	global.startRoom = rWaiting;         //Sets which room to begin with
	global.roomCaptionDef = "I Had The First Instance";  //Sets default window caption (only works with the Professional version of Studio)
